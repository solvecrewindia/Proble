    ...
    return (
        <div className="space-y-6">
            <div className="text-center space-y-2">
                <h2 className="text-2xl font-bold text-neutral-900">Choose Assessment Type</h2>
                <p className="text-neutral-500">Select how you want to publish this test.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 pt-8">
                ...
                >
                    <div className={cn(
                        ...
                        data.type === 'global' ? "bg-primary text-white" : "bg-neutral-100 text-neutral-500 group-hover:text-primary"
                    )}>
                        <Globe className="h-6 w-6" />
                    </div>
                    <h3 className="text-xl font-bold text-neutral-900 mb-2">Global Test</h3>
                ...
                >
                    <div className={cn(
                        "h-12 w-12 rounded-full flex items-center justify-center mb-4 transition-colors",
                        data.type === 'master' ? "bg-primary text-white" : "bg-neutral-100 text-neutral-500 group-hover:text-primary"
                    )}>
                        <Lock className="h-6 w-6" />
                    </div>
                    <h3 className="text-xl font-bold text-neutral-900 mb-2">Master Test</h3>
                    <p className="text-sm text-neutral-500 leading-relaxed">
