    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid gap-4">
                {activeTab === 'ongoing' && (
                    <Card className="border-l-4 border-l-green-500 bg-surface border-border-custom">
                        <CardContent className="p-6">
                            <div className="flex justify-between items-start">
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        <Badge variant="success" className="animate-pulse">Live Now</Badge>
                                        <span className="text-xs text-muted">Started 15m ago</span>
                                    </div>
                                    <h3 className="text-xl font-bold text-text">Advanced Algorithms Final</h3>
                                    <p className="text-sm text-muted">Code: <span className="font-mono font-bold text-text">ALGO-2024-X</span></p>
                                </div>
                                <Button>
                ...
                {activeTab === 'scheduled' && (
                    <div className="text-center py-12 text-muted">No scheduled tests found.</div>
                )}
            </div>
        </div>
    );
